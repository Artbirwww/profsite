...
export function Registration({ onRegister, onSwitchToLogin }: RegistrationProps) {
  ...
  const getCitiesByRegion = (regionValue: string) => {
    const citiesMap: { [key: string]: { value: string; label: string }[] } = {
      ...
      // Списки городов по регионам (актуально на 2025 г.)

      'тыва': [
        { value: 'кызыл', label: 'Кызыл' },
        { value: 'ак-довурак', label: 'Ак-Довурак' },
        { value: 'туран', label: 'Туран' },
        { value: 'чадан', label: 'Чадан' },
      ],

      'хакасия': [
        { value: 'абакан', label: 'Абакан' },
        { value: 'черногорск', label: 'Черногорск' },
        { value: 'саяногорск', label: 'Саяногорск' },
        { value: 'усть-абакан', label: 'Усть-Абакан' },
        { value: 'абаза', label: 'Абаза' },
      ],
      ...
      'красноярский край': [
        ...
        { value: 'кузнецк', label: 'Канск' },
        { value: 'железногорск', label: 'Железногорск' },
        { value: 'лесосибирск', label: 'Лесосибирск' },
        { value: 'дивногорск', label: 'Дивногорск' },
      ...
      'новосибирская область': [
        ...
        { value: 'искитим', label: 'Искитим' },
        { value: 'обь', label: 'Обь' },
        { value: 'коляново', label: 'Колывань' },
        { value: 'чулым', label: 'Чулым' },
        { value: 'татарск', label: 'Татарск' },
        { value: 'караганда', label: 'Каргат' },
      ],

      'томская область': [
        { value: 'томск', label: 'Томск' },
        { value: 'северск', label: 'Северск' },
        { value: 'асино', label: 'Асино' },
        { value: 'колпашево', label: 'Колпашево' },
        { value: 'стожки', label: 'Стожки' },
        { value: 'зирка', label: 'Зирка' },
      ],
    };
