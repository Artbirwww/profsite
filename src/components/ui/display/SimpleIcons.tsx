...
export function CheckCircle({ className = '' }: IconProps) {
  return (
    ...
    >
      <circle cx="12" cy="12" r="10" />
      <polyline points="16 8 11 16 8 12" />
    </svg>
  );
}
...
export function Brain({ className = '' }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 5a4 4 0 0 0-4 4c0 .5.2 1 .4 1.4a6 6 0 0 1 7.2 0c.2-.4.4-.9.4-1.4a4 4 0 0 0-4-4Z" />
      <path d="M12 13a6 6 0 0 0-6 6v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a6 6 0 0 0-6-6Z" />
      <path d="M18 9a4 4 0 1 0-4 4" />
      <path d="M6 15a4 4 0 1 0 4-4" />
    </svg>
  );
}
