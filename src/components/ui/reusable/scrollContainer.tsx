...
export const ScrollContainer = <Items extends { id: string | number }>({ items, renderItem, className = "", visibleCount = 3, step = 3, scrollDelay = 300, itemsGap = "0px" }: ScrollContainerProps<Items>) => {
