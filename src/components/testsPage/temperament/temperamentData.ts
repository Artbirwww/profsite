...
export const temperamentTypes = {
    choleric: {
        ...
        description: "Вы обладаете сильной нервной системой и быстро реагируете на события. Легко увлекаетесь новыми идеями, но можете так же быстро остывать. В работе вам важно движение и новые вызовы. Лучше всего проявляете себя в ситуациях, где нужно быстро принимать решения и брать инициативу.",
        traits: ["Лидерские качества", "Решительность", "Энергичность", "Импульсивность"],
        professions: ["Менеджер", "Предприниматель", "Спортсмен", "Актёр"],
    },
    sanguine: {
        name: "Сангвиник",
        shortDescription: "Общительный, жизнерадостный, оптимистичный, адаптивный",
        description: "Вы легко сходитесь с людьми и быстро приспосабливаетесь к новым условиям. Ваша энергия и оптимизм заряжают окружающих. Не любите однообразие, предпочитаете разнообразные задачи и живое общение. Отлично работаете в команде и легко справляетесь со стрессом.",
        traits: ["Коммуникабельность", "Оптимизм", "Адаптивность", "Позитивность"],
        professions: ["Продавец", "Журналист", "Педагог", "Ведущий мероприятий"],
    },
    phlegmatic: {
        name: "Флегматик",
        shortDescription: "Спокойный, уравновешенный, надёжный, последовательный",
        description: "Вы сохраняете спокойствие в любых ситуациях и не поддаётесь эмоциональным качелям. Предпочитаете размеренный темп работы, тщательно обдумываете решения. На вас можно положиться — вы доводите дела до конца и не бросаете слова на ветер. Лучше всего работаете в стабильной обстановке без сюрпризов.",
        traits: ["Спокойствие", "Надёжность", "Усидчивость", "Терпеливость"],
        professions: ["Бухгалтер", "Аналитик", "Программист", "Исследователь"],
    },
    melancholic: {
        name: "Меланхолик",
        shortDescription: "Чувствительный, глубокий, аналитичный, творческий",
        description: "Вы тонко чувствуете мир и замечаете то, что ускользает от других. Склонны к глубокому анализу и творческому осмыслению. Может быть, вы не самый быстрый в принятии решений, зато ваши выводы часто оказываются самыми точными. Вам важно работать в спокойной обстановке, где можно сосредоточиться.",
        traits: ["Чувствительность", "Аналитичность", "Творчество", "Внимательность"],
        professions: ["Художник", "Психолог", "Писатель", "Дизайнер"],
    },
    unreliable: {
        name: "Результат недостоверен",
        shortDescription: "Высокий уровень социальной желательности",
        description: "Ваши ответы могут быть неискренними или вы старались казаться лучше, чем есть на самом деле. Попробуйте пройти тест ещё раз, отвечая более откровенно.",
        traits: [],
        professions: [],
    }
};
