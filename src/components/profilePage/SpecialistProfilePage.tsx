...
import { UserPen, MailOpen, School, Hash, CaseUpper, PersonStanding, CheckCheck, SpellCheck } from "lucide-react"
...
export const SpecialistProfilePage = () => {
    const [specialist, setSpecialist] = useState<Specialist>({email: '',
                                            ...
                                            experience: '', jobSatisfaction: '',
                                            profession: '', gender: Gender.MALE})
            ...
            <div className="profile-container">
                <div className="profile-grid">
                    ...
                    <div className="profile-grid-item profile-grid-item-5">
                      ...
                      <div className="profile-grid-item profile-grid-item-6">
                        <div className="profile-grid-item-container">
                            <div className="profile-grid-wrapper">
                                <div className="profile-grid-item-header">
                                ...
                                <select name="profession"
                                        value={specialist.profession ? specialist.profession : "Ваша профессия"}
                                        onChange={handleChange}>
                    ...
                    <div className="profile-options profile-grid-item-7 ">
                        <Button
